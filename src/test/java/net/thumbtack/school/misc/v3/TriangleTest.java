...
import net.thumbtack.school.misc.v2.Triangle;
...
class TriangleTest {
    ...
    public void testTriangle() {
        ...
        net.thumbtack.school.misc.v2.Triangle triangle = new net.thumbtack.school.misc.v2.Triangle(point1, point2, point3);
        assertAll(
    ...
    public void testMoveTriangle() {
        ...
        Point point2 = new Point(30, 10);
        Point point3 = new Point(20, 30);
        net.thumbtack.school.misc.v2.Triangle triangle = new Triangle(point1, point2, point3);
